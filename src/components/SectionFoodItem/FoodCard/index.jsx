//Styles
import {Img, ContentWrap, Desc, DescWrap, FoodCardStyles, Link, LinkWrap, Loc, LocWrap, Title, TitleWrap} from './styled';

const FoodCard = ({img, title, description, location, link }) => {
	return (
		<FoodCardStyles>
